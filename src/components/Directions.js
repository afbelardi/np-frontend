  ...
  return (
    <div className="flex flex-col items-center justify-center w-full mt-4 mb-10">
        <section className="flex items-center justify-center">
            ...
            <h1 className={`  ${styles2["text-shadow"]} text-4xl font-medium text-white font-monserrat`}>Directions</h1>     
        </section>
        <main className="flex flex-col items-center">
            <p className={` ${styles2["text-shadow"]} p-5 mb-2 text-lg font-light leading-7 text-center text-off-white font-monserrat`}>{park.directionsInfo}</p>
